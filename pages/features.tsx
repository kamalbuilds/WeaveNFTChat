import { Box, Grid, chakra, Text, Flex, Avatar } from '@chakra-ui/react';
...
export default function FourLogosGrid() {
  return (
    <Box p={4} textColor={'black'}>
      ...
      <Grid templateColumns={{ base: 'repeat(1, 1fr)', md: 'repeat(4, 1fr)' }} gap={8}>
